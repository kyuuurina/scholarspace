...
//     value: string;
//     user_id: string;
//     created_at: string; // Update the type if needed
//   };
// };
...
//       </footer>
//       <div dangerouslySetInnerHTML={{ __html: value || "Add a detailed description here...." }}></div>
...
import type { post_comments } from "@prisma/client";
import { api } from "~/utils/api";
