        ...
        <div className="p-5">
            ...
            <section className="mt-2 w-3/4 mx-auto rounded-sm border border-gray-200 bg-white p-4 shadow sm:p-6 md:p-8">
              <div className="flex justify-between items-center">
                ...
                <div>
                  ...
                  {/* Follow button */}
                  {!isCurrentUserProfile && <FollowButton userId={id as string} />}
                </div>
              </div>
              <div>
          ...
          <div className="grid gap-y-5">
            <section className="mt-2 w-3/4 mx-auto rounded-sm border border-gray-200 bg-white p-4 shadow sm:p-6 md:p-8">
              ...
              {/* Add Experience Button on the right side */}
              {isCurrentUserProfile && (
                <button
          ...
          <div className="grid gap-y-5">
            <section className="mt-2 w-3/4 mx-auto rounded-sm border border-gray-200 bg-white p-4 shadow sm:p-6 md:p-8">
              ...
              {/* Add Achievement Button on the right side */}
              {isCurrentUserProfile && (
                <button
            ...
            {/* Render AchievementForm passing modal state and onClose handler */}
