...
-- CreateTable
CREATE TABLE "public"."ResearchPosts" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "avatar" TEXT NOT NULL,
    ...
    CONSTRAINT "ResearchPosts_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."research_interests" (
    ...
    CONSTRAINT "researchInterests_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "public"."workspace_user" (
    ...
    "workspace_role" TEXT DEFAULT 'Researcher',
    "ownerid" TEXT,
    "is_collaborator" BOOLEAN DEFAULT false,

    CONSTRAINT "workspace_user_pkey" PRIMARY KEY ("workspaceid","userid")
);
...
-- AddForeignKey
ALTER TABLE "public"."workspace_user" ADD CONSTRAINT "workspace_user_userid_fkey" FOREIGN KEY ("userid") REFERENCES "public"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."workspace_user" ADD CONSTRAINT "workspace_user_workspaceid_fkey" FOREIGN KEY ("workspaceid") REFERENCES "public"."workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
